   ...
   public function index(Request $request)
    {
        try {
            ...
            $error_code="A003";
            $error_msg="Error in User Login: ".$error_code." ".$e->getmessage().". Please check your process or report to ".env('APP_NAME')." ";
    ...
    public function postLogin(Request $request)
    {
        try {
            ...
            $error_code="A004";
            $error_msg="Error in User Post Login: ".$error_code." ".$e->getmessage().". Please check your process or report to ".env('APP_NAME')." ";
            return view('error',compact('error_msg'))->with('alert-danger', $error_msg);
        }
    }
    ...
    public function logout()
    {
        try {
            ...
            $error_code="A005";
            $error_msg="Error in Logout: ".$error_code." ".$e->getmessage().". Please check your process or report to ".env('APP_NAME')." ";
            return view('error',compact('error_msg'))->with('alert-danger', $error_msg);
        }
